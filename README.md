...
The downloader is specifically geared toward downloading Ubuntu ISOs from the daily image locations. There's a very good chance it will fail when downloading ISOs for other distros (or even when downloading ISOs for other forms of Ubuntu). I intend to fix this in the Bash form of the script if possible.
